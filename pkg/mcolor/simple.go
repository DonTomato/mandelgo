...
func createSimpleRGBA(data []mcalc.MandelIterationResult, settings *mcalc.MandelSettings, getColor func(mcalc.MandelIterationResult) color.Color) *image.RGBA {
